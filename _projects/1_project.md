...
<div class="row">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/imagemVerlab2.jpeg" title="Research at Verlab 2" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/miniwaypoints.py" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
